    ...
    value: ({ projects }) => {
      ...
      return html`
        ...
        <main class="portfolio-page">
          <app-breadcrumb
            items="${JSON.stringify([{ label: 'Home', href: '/' }, { label: 'Portfolio' }])}"
          ></app-breadcrumb>
          <h1>Portfolio</h1>
          <p class="portfolio-subtitle">
            Open source projects I'm currently building or maintaining.
          </p>
            ...
            ? html`
                <div class="portfolio-grid">
                  ${projects.map(
                    (p) => html`
                      <a
                        href="${router.url(PortfolioDetailView, { id: p.id })}"
                      ...
                      >
                        <div class="portfolio-card__header">
                          ...
                          <span
                            ...
                            style="--status-color: ${STATUS_COLORS[p.status] ||
